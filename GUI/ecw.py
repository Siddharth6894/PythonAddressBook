...
class EditContactWindow(object):
	...
	def __init__(self, master, name, entry_id):
		...
		self.last_name_label.grid(row = 1,pady=3)
		...
		self.save_button = Tk.Button(top, text= 'Save', command = self.field_return,font=('Helvetica',9,'bold') )
		self.save_button.grid(row = 12, column = 1,padx = 12,pady=22)

		self.cancel_button = Tk.Button(top, text = 'Cancel', command = self.close_window,font=('Helvetica',9,'bold'))
		self.cancel_button.grid(row = 12, column = 1,sticky = Tk.E)
