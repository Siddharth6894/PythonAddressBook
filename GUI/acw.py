...
class AddContactWindow(object):
	...
	def __init__(self,master):
		...
		self.first_name.grid(row = 0, column = 1, padx = 10,pady=3)
		...
		self.last_name.grid(row = 1, column = 1,pady=3)
		...
		self.address1.grid(row = 2, column = 1,pady=3)
		...
		self.address2.grid(row = 3, column = 1,pady=3)
		...
		self.city.grid(row = 4, column = 1,pady=3)
		...
		self.state.grid(row = 5, column = 1,pady=3 )

		self.zip_label = Tk.Label(top, text= 'Pin code:')
		self.zip_label.grid(row = 6)

		#input for the contacts zip
		self.zip = Tk.Entry(top)
		self.zip.grid(row = 6, column = 1,pady=3)

		# Input for contact home phone
		self.home_label = Tk.Label(top, text = 'TelePhone:')
		self.home_label.grid(row = 7)

		self.home = Tk.Entry(top)
		self.home.grid(row = 7, column = 1,pady=3)
		...
		self.mobile.grid(row = 8, column = 1,pady=3)
		...
		self.email.grid(row = 9, column = 1,pady=3)

		self.birthday_label = Tk.Label(top, text = 'DOB:')
		self.birthday_label.grid(row = 10)

		#input for contacts birthday
		self.birthday = Tk.Entry(top)
		self.birthday.grid(row = 10, column = 1,pady=3)
		...
		self.notes.grid(row = 11, column = 1,pady=3)

		self.add_button = Tk.Button(top, text='Add', command=self.field_return, font=('Helvetica', 9, 'bold'))
		self.add_button.grid(row=13, column=1, padx=10)

		self.cancel_button = Tk.Button(top, text = 'Cancel', command = self.close_window,font=('Helvetica',9,'bold'))
		self.cancel_button.grid(row = 13, column = 1,pady=20,sticky=Tk.E)
